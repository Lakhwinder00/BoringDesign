...
export class PaginationComponent implements OnInit {
  ...
  pageChangeIndex(index: number) {
    ...
    if (index > this.defaultPage) {
      ...
      this.defaultPage = this.defaultPage > index ? this.defaultPage - this.pageIndexNumberSize : index + pageNo;
      this.startPage = this.defaultPage > this.pageIndexNumberSize ? this.defaultPage - this.pageIndexNumberSize : 0;
    }
