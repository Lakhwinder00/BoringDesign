...
export class ProjectsComponent implements OnInit {
  ...
  closeDialog()
  {
    this.modalRef.close(this.uploadFileData);
  }
  newProject() {
   // this.modalRef.close();
  ...
  updateProject(item:any){
    let UpdateProjectDialog= this.dialog.open(NewProjectComponent,{data:item.projectName, width:'500px',panelClass:'new-project-cls'});
  ...
  {
    let deleteDialog=this.dialog.open(DialogConfirmComponent,{data: {
